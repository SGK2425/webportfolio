...
const TstLogoImg = ({ height = '3rem', width = '3rem', ...props }) => (
  <svg
    {...props}
    viewBox="0 0 32 32"
    height={height}
  ...
  >
    <linearGradient id="logoGradient" x1="0%" y1="0%" x2="100%" y2="0%"> {/* Adjust gradient direction as needed */}
      <stop offset="0%" stopColor="rgb(79, 91, 213)" /> {/* Start color (blue-400 equivalent) */}
      <stop offset="100%" stopColor="rgb(124, 58, 237)" /> {/* End color (purple-500 equivalent) */}
    </linearGradient>
    <path
